...
public class QueryFilesActivity extends BaseDemoActivity {
    ...
    private void listFiles() {
        Query query = new Query.Builder()
                              ...
                              .build();
//        Query query = new Query.Builder()
//                .addFilter(Filters.eq(SearchableField.TITLE, "Deepak File New"))
//                .build();
        // [START query_files]
                ...
                .addOnSuccessListener(this,
                        metadataBuffer -> {
                            ...
                            for (Metadata mss: metadataBuffer){
                                Log.d(TAG, "listFiles: "+mss.getTitle()+"\n"+mss.getDriveId());
                                if(mss.equals("Deepak File New"))
                                Log.d(TAG, "listFilesdddd: "+mss.getTitle()+"\n"+mss.getDriveId());
                            }
                            Log.d(TAG, "listFiles: ");
                            // [END_EXCLUDE]
                        })
