...
public abstract class BaseDemoActivity extends Activity {
    ...
    public boolean isDriveInitialized() {
        ...
        requiredScopes.add(Drive.SCOPE_APPFOLDER);
        GoogleSignInAccount signInAccount = GoogleSignIn.getLastSignedInAccount(this);
        boolean isInitialized = signInAccount != null && signInAccount.getGrantedScopes().containsAll(requiredScopes);
    ...
    public void init() {
        ...
        if (signInAccount != null && signInAccount.getGrantedScopes().containsAll(requiredScopes)) {
            ...
            if (this instanceof Activity) {
                ((Activity) this).startActivityForResult(googleSignInClient.getSignInIntent(), REQUEST_CODE_SIGN_IN);
            } else {
                Log.e(TAG, "Activity context required");
            }
        }
    }
